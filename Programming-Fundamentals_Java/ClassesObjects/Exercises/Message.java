...
public class Message {
    ...
    public String randomMessage() {
        return String.format("%s %s %s - %s", phrases[rnd.nextInt(phrases.length)], events[rnd.nextInt(events.length)], author[rnd.nextInt(author.length)], town[rnd.nextInt(town.length)]);
    }
}
